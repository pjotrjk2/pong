...
ifneq (,$(pong_config))
	...
	@${MAKE} --no-print-directory -C build/build_files -f pong.make config=$(pong_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f pong.make clean
